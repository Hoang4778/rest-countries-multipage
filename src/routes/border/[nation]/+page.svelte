...
<div id="container">
  ...
  <div id="info">
    ...
    <div>
      ...
      <div id="desc">
        <p>
          <span>Native Name:</span><span
            class="info"
            class:lightmode-text={$lightmode}>{nativeNames}</span
          >
        </p>
        <p>
        ...
        <p>
          <span>Population:</span><span
            class="info"
            class:lightmode-text={$lightmode}>{population}</span
          >
        </p>
        <p>
          <span>Currencies:</span><span
            class="info"
            class:lightmode-text={$lightmode}>{currencies}</span
          >
        </p>
        <p>
          <span>Region:</span><span
            class="info"
            class:lightmode-text={$lightmode}>{country.region}</span
          >
        </p>
        <p>
          <span>Languages:</span><span
            class="info"
            class:lightmode-text={$lightmode}>{languages}</span
          >
        </p>
        <p>
          <span>Sub Region:</span><span
            class="info"
            class:lightmode-text={$lightmode}>{country.subregion}</span
          >
        </p>
        <p>
          <span>Capital:</span><span
            class="info"
            class:lightmode-text={$lightmode}>{country.capital}</span
          >
        </p>
      </div>
    </div>
